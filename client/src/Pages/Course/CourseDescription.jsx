  ...
  return (
    <HomeLayout>
      <div className="px-4 md:px-0 flex items-center justify-center">
        <div className="min-h-[80vh] mt-3 w-full md:w-3/4 rounded-xl bg-slate-600 py-5 px-4 md:px-10 flex flex-col items-center justify-center text-white">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-10 py-10 relative">
